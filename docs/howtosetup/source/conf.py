...
project = u'A4MCAR Introduction and Setup'
...
latex_documents = [
    (master_doc, 'A4MCAR.tex', u'A4MCAR Introduction and Setup Manual',
...
man_pages = [
    (master_doc, 'a4mcar', u'A4MCAR Introduction and Setup Manual',
     [author], 1)
]
